...
\title{An R package for the automatic generation of rule-based matrices}
\author{by Debora de Chiusole, Andrea Brancaccio, and Ottavia M. Epifania}
...
\begin{figure}
\centering
\includegraphics{iRidePaper_files/figure-latex/penguins-ggplot-1.pdf}
...
\address{%
Debora de Chiusole\\
Deparment of Philosofy, Sociology, Education and Applied Psychology, University of Padova\\%
